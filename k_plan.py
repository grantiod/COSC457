...
class K_Plan:
    ...
    def submit(self):
        ...
        pay_ytd = self.pay_ytd_e.get()
        self.pay_ytd_e.delete(0, END)
        ...
        c.execute("INSERT INTO K_PLAN VALUES (" + account_num + "," + inv_per + "," + em_con_per + "," + pay_ytd + "," + employee_num + ")")
    ...
    def run(self):
        ...
        self.pay_ytd_lbl = Label(self.root, text='Payment YTD:')
        self.pay_ytd_lbl.grid(row=0, column=6, padx=5, pady=5)
        self.pay_ytd_e = Entry(self.root, width=10, borderwidth=1)
        self.pay_ytd_e.grid(row=0, column=7, padx=5, pady=5)
