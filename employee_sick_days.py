...
class Employee_Sick_Days:
    def __init__(self):
        self.root = Tk()
        self.root.title('Employee Sick Days')
    ...
    def submit(self):
        ...
        c.execute("INSERT INTO EMPLOYEE_SICK_DAYS VALUES (\"" + employee_name + "\"," + employee_num + ",\"" + dates_off + "\"," + num_allotted + ")")
